    ...
    public class Setting
    {
        ...
        private static void SetNewValueIntoSettingModel()
        {
            try
            {
                ...
                _settingModel.FileExtensionNames = jObject[nameof(SettingJsonModel.FileExtensionNames)].ToObject<List<string>>();
                _settingModel.AutoStart = (bool)jObject[nameof(SettingJsonModel.AutoStart)];
                ...
                _settingModel.UseStatAndBatchOption = (bool)jObject[nameof(SettingJsonModel.UseStatAndBatchOption)];
                _settingModel.MinimizeWindowWhenProgramStart = (bool)jObject[nameof(SettingJsonModel.MinimizeWindowWhenProgramStart)];
                _settingModel.ShowCloseAndMinimizeButton = (bool)jObject[nameof(SettingJsonModel.ShowCloseAndMinimizeButton)];
                _settingModel.ShowXY = (bool)jObject[nameof(SettingJsonModel.ShowXY)];
                _settingModel.FilterMedicineCode = (bool)jObject[nameof(SettingJsonModel.FilterMedicineCode)];
                _settingModel.OnlyCanisterIn = (bool)jObject[nameof(SettingJsonModel.OnlyCanisterIn)];
                _settingModel.WhenCompeletedMoveFile = (bool)jObject[nameof(SettingJsonModel.WhenCompeletedMoveFile)];
                _settingModel.WhenCompeletedStop = (bool)jObject[nameof(SettingJsonModel.WhenCompeletedStop)];
                _settingModel.IgnoreAdminCodeIfNotInOnCube = (bool)jObject[nameof(SettingJsonModel.IgnoreAdminCodeIfNotInOnCube)];
