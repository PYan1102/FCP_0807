...
namespace FCP.Providers
{
    public class ColorProvider
    {
        ...
        private static string _shallowBlue = "#85B9F4";
        ...
        private static void InitSolidColorBrushDict()
        {
            ...
            _solidColorBrushDict.Add(eColor.ShallowBlue, new SolidColorBrush((Color)ColorConverter.ConvertFromString(_shallowBlue)));
