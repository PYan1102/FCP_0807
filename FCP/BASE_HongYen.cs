...
namespace FCP
{
    ...
    {
        FMT_HongYen HY;
        public BASE_HongYen(MainWindow mw, Settings s)
        {
            Loaded(mw, s);
        }
        ...
        public override void Converter()
        {
            ...
            if (HY == null)
                HY = new FMT_HongYen();
            HY.Load(base.InputPath, base.OutputPath, base.FilePath, base.NowSecond, Settings, base.Log);
            Result(HY.MethodShunt(null), true, true);
        }
