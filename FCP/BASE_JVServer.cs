...
namespace FCP
{
    class BASE_JVServer:FunctionCollections
    {
        ...
        public BASE_JVServer(MainWindow mw, Settings s)
        {
            Loaded(mw, s);
        }
        ...
        public override void Converter()
        {
            ...
            JVS.Load(base.InputPath, base.OutputPath, base.FilePath, base.NowSecond, Settings, base.Log);
            Result(JVS.MethodShunt(null), true, true);
        }
