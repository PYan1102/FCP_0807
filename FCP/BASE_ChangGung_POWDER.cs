...
namespace FCP
{
    class BASE_ChangGung_POWDER : FunctionCollections
    {
        ...
        public BASE_ChangGung_POWDER(MainWindow mw, Settings s)
        {
            Loaded(mw, s);
        }
        ...
        public override void Converter()
        {
            ...
            CG_P.Load(base.InputPath, base.OutputPath, base.FilePath, base.NowSecond, Settings, base.Log);
            Result(CG_P.MethodShunt(null), true, true);
        }
